      ...
      <div className={styles.fourthSectStyle}>
        ...
        <div className={styles.socialContacts}>
          <a
            target="_blank"
            rel="noreferrer"
            className={styles.linkBiLink}
            href="https://www.linkedin.com/in/raul-henrique/"
          ...
          <a
            ...
            rel="noreferrer"
            className={styles.linkBiGit}
            href="https://github.com/raulhenrique-x3"
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
              fill="currentColor"
          ...
          <a
            ...
            className={styles.linkBiWpp}
            href="https://wa.me/5581986838081"
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
              fill="currentColor"
          ...
          <a href="mailto:raulheri43@hotmail.com" aria-label="Email Icon">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="16"
              height="16"
              fill="currentColor"
              className={styles.bienvelope}
              viewBox="0 0 16 16"
            >
