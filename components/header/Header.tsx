    ...
    <>
      <header className={styles.header}>
        ...
        <div className={styles.socialContacts}>
          ...
          <a target="_blank" aria-label="Github icon" rel="noreferrer" href="https://github.com/raulhenrique-x3">
          ...
          <a target="_blank" aria-label="Whatsapp icon" rel="noreferrer" href="https://wa.me/5581986838081">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              fill="currentColor"
