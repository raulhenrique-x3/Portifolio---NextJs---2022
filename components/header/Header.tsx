            ...
            <header className={styles.header}>
                <div data-nosnippet className={styles.logoMenu}>
                    ...
                    <button onClick={() => setActive(!active)} className={styles.button}>
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className={styles.biList} viewBox="0 0 16 16">
                ...
                <div className={styles.socialContacts}>
                    <a className={styles.linkBiLink} href="https://www.linkedin.com/in/raul-henrique/"><svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" className={styles.biLinkedin} viewBox="0 0 16 16">
                    ...
                    <a className={styles.linkBiGit} href="https://github.com/raulhenrique-x3"><svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" className={styles.biGithub} viewBox="0 0 16 16">
                    ...
                    <a className={styles.linkBiWpp} href="https://wa.me/5581986838081"><svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" className={styles.biWhatsapp} viewBox="0 0 16 16">
