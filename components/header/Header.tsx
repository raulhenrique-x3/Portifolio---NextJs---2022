        ...
        <>
            <header className={styles.header}>
                ...
                <div className={styles.socialContacts}>
                    <a href="https://www.linkedin.com/in/raul-henrique/"><svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" className={styles.biLinkedin} viewBox="0 0 16 16">
                    ...
                    <a href="https://github.com/raulhenrique-x3"><svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" className={styles.biGithub} viewBox="0 0 16 16">
                    ...
                    <a href="https://wa.me/5581986838081"><svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" className={styles.biWhatsapp} viewBox="0 0 16 16">
