        ...
        <div className={styles.thirdSectInfo}>
          ...
          <div className={styles.myInfo}>
            ...
            <ul className={styles.iconList}>
              ...
              <li className={styles.listIcon}>
                <Image className={styles.iconTech} src="/sass-original.svg" width={44} height={44} alt="Sass" />
              </li>
              <li className={styles.listIcon}>
                <Image className={styles.iconTech} src="/typescript-plain.svg" width={44} height={44} alt="Bootstrap" />
              </li>
            </ul>
