    ...
    return (
        <section className={styles.fourthSect} id='contacts'>
            <div className={styles.fourthSectStyle}>
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1440 320"><path fill="#266398" fillOpacity="1" d="M0,224L48,208C96,192,192,160,288,122.7C384,85,480,43,576,58.7C672,75,768,149,864,160C960,171,1056,117,1152,117.3C1248,117,1344,171,1392,197.3L1440,224L1440,0L1392,0C1344,0,1248,0,1152,0C1056,0,960,0,864,0C768,0,672,0,576,0C480,0,384,0,288,0C192,0,96,0,48,0L0,0Z"></path></svg>
                <p className={styles.contacts}>CONTATOS</p>
                <div className={styles.socialContacts}>
                    <a className={styles.linkBiLink} href="https://www.linkedin.com/in/raul-henrique/">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" className={styles.biLinkedin} viewBox="0 0 16 16">
                    ...
                    <a className={styles.linkBiGit} href="https://github.com/raulhenrique-x3">
                    ...
                    <a className={styles.linkBiWpp} href="https://wa.me/5581986838081">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" className={styles.biWhatsapp} viewBox="0 0 16 16">
                    ...
                    <a href="mailto:raulheri43@hotmail.com">
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className={styles.bienvelope} viewBox="0 0 16 16">
