    ...
    <section className={styles.fourthSect} id="contacts">
      <div className={styles.fourthSectStyle}>
        ...
        <div className={styles.socialContacts}>
          ...
          <a target="_blank" rel="noreferrer" className={styles.linkBiGit} href="https://github.com/raulhenrique-x3">
          ...
          <a target="_blank" rel="noreferrer" className={styles.linkBiWpp} href="https://wa.me/5581986838081">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              fill="currentColor"
